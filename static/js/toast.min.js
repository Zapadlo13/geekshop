class Toast {
    constructor(t) {
        this._title = !1 !== t.title && (t.title || "Title"),
            ...
            console.log(this._title), this._create(),
    ...
    _create() {
        ...
        t.classList.add("toast-message"), t.classList.add(`toast_${this._theme}`);
        ...
        if (e = e.replace("{header}", s), t.innerHTML = e, this._title ? t.querySelector(".toast__header").textContent = this._title : t.classList.add("toast_message"),
            t.querySelector(".toast__body").textContent = this._text, this._el = t, !document.querySelector(".toast-container-message")) {
            const t = document.createElement("div");
            t.classList.add("toast-container-message"), document.body.append(t)
        }
        document.querySelector(".toast-container-message").append(this._el)
    }
}


document.querySelector('.toast-remove').onclick = () => {
      /*
